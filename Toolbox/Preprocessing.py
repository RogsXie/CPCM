...
import matplotlib
matplotlib.use('TkAgg')  # 或 'Agg'（无 GUI，适合服务器运行）
...
class Processor:
    ...
    def show_class_map(self, y_pre, y_indx, gt, show=True, save='classification_map.png'):
        ...
        if save is not False:
            plt.savefig(save, format='png', bbox_inches='tight', dpi=300)  # 设置dpi提高图像清晰度
